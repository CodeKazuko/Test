...
export const createReview = async (productId, review) => {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/api/products/${productId}/reviews`, options)
    const json = await response.json()
    if (response.status !== 201) {
      throw new Error(json.message)
    }
...
export const updateProduct = async (product) => {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/api/products/${product._id}`, options)
    const json = await response.json()
    if (response.status !== 200) {
      throw new Error(json.message)
    }
...
export const deleteProduct = async (productId) => {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/api/products/${productId}`, options)
    const json = await response.json()
    if (response.status !== 200) {
      throw new Error(json.message)
    }
...
export const payOrder = async (orderId, paymentResult) => {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/api/orders/${orderId}/pay`, options)
    const json = await response.json()
    if (response.status !== 200) {
      throw new Error(json.message)
    }
...
export const deliverOrder = async (orderId) => {
  ...
  try {
    const response = await fetch(
      `${apiUrl}/api/orders/${orderId}/deliver`, options)
    const json = await response.json()
    if (response.status !== 200) {
      throw new Error(json.message)
    }
